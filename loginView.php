...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-100 m-auto">
        <form name="login_form" action="./controller/login.php" method="post">
            <img class="mb-4 mt-5 mx-auto d-block" src="./images/kailogo.png" alt="" height="200">
            ...
            <button class="btn btn-primary w-100 py-2" type="button" id="btn_login">Sign in</button>
            <p class="mt-5 mb-3 text-body-secondary">&copy; KAI Certification Inc. 2023</p>
        </form>
    </main>
