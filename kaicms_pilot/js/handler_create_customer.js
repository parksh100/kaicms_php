...
window.onload = function () {
  ...
  document.getElementsByName('dev').forEach(function (elem) {
    elem.addEventListener('change', function () {
      let employeeCountRow = document.querySelector('#employee-count-row');
  ...
  document.getElementsByName('exclusion').forEach(function (elem) {
    elem.addEventListener('change', function () {
      let exclusionReasonRow = document.querySelector('#exclusion_reason_row');
  ...
  document.getElementsByName('outsourcing').forEach(function (elem) {
    elem.addEventListener('change', function () {
      let outsourcingRow = document.querySelector('#outsourcingRow');
  ...
  document.getElementsByName('construction_license').forEach(function (elem) {
    elem.addEventListener('change', function () {
      let constructRow = document.querySelector('#construction_content_row');
  ...
  document.getElementsByName('ctype').forEach(function (elem) {
    elem.addEventListener('change', function () {
      let beforeCertRow = document.querySelector('#before_cert_row');
